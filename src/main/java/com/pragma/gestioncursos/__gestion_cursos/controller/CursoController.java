...
public class CursoController {
    ...
    @GetMapping("/cursos")
    public String listarCursos(Model model, @Param("keyword") String keyword, @RequestParam(defaultValue = "1") int page, @RequestParam(defaultValue = "3") int size){ //en este metodo se agrega la paginación
        try{
            List<Curso> cursos = new ArrayList<>();
            //Page-1 por que empezamos en la pagina cero (0)
    ...
    public String agregarCurso(Model model){
        ...
        model.addAttribute("pagesTitle", "Nuevo curso");
        return "curso_form";
    }
